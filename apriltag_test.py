...
# 图像文件夹路径
left_folder_path = "C:/Users/pengchen/Desktop/puncture/Apriltag/L"

right_folder_path = "C:/Users/pengchen/Desktop/puncture/Apriltag/R"
...
def calculate_transformation_matrix(left_image_path, right_image_path):
    ...
    gray_left_rectified = cv2.cvtColor(img_right_rectified, cv2.COLOR_BGR2GRAY) ###########修改这里
...
def compute_transformation_matrix(points, output_file=None):
...
output_file = "patientMotion3_R.txt"
...
for left_file, right_file in zip(left_image_files, right_image_files):
            ...
            # 计算x_axis
            # x_axis = transformation_matrix[:3, 0]  # 提取变换矩阵的第一列作为x_axis向量
            # 打印x_axis信息
            # print("x_axis:", x_axis)

            compute_transformation_matrix(transformation_matrix, output_file)
            # projected_point_3 = compute_transformation_matrix(transformation_matrix)

            # # 打印 projected_point_3 信息
            # print("projected_point_0:", projected_point_0)
            # print("projected_point_3:", projected_point_3)
            ...
            # plane_coefficients, _ = PlaneEstimateByLS(transformation_matrix)
            # A, B, C, D = plane_coefficients  # 提取平面参数
            # print(A, B, C, D)